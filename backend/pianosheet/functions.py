...
class Translate():
    ...
    cyr = ('Ы', 'ы', 'Е', 'е', 'æ', 'ç', 'ê', 'é', 'è', 'ô', 'â', 'à', 'î',
           'û', 'ù', 'ú', 'œ', 'ü', 'ë', 'ï', 'ж', 'ч', 'щ', 'ш', 'ю', 'а',
           'б', 'в', 'г', 'д', 'e', 'з', 'и', 'й', 'к', 'л', 'м', 'н', 'о',
           'п', 'р', 'с', 'т', 'у', 'ф', 'х', 'ц', 'ъ', 'ь', 'я', 'Ж', 'Ч',
           'Щ', 'Ш', 'Ю', 'А', 'Б', 'В', 'Г', 'Д', 'Е', 'З', 'И', 'Й', 'К',
           'Л', 'М', 'Н', 'О', 'П', 'Р', 'С', 'Т', 'У', 'Ф', 'Х', 'Ц', 'Ъ',
           'Ь', 'Я', '/', '\\', ':', '?', '<', '>', '"', '|', '*', '.', ',',
           ' ')

    lat = ('I', 'i', 'E', 'e', 'ae', 'c', 'e', 'e', 'e', 'o', 'a', 'a', 'i',
           'u', 'u', 'u', 'oe', 'u', 'e', 'i', 'zh', 'ch', 'sht', 'sh', 'yu',
           'a', 'b', 'v', 'g', 'd', 'e', 'z', 'i', 'j', 'k', 'l', 'm', 'n',
           'o', 'p', 'r', 's', 't', 'u', 'f', 'h', 'c', 'y', 'x', 'ya', 'Zh',
           'Ch', 'Sht', 'Sh', 'Yu', 'A', 'B', 'V', 'G', 'D', 'E', 'Z', 'I',
