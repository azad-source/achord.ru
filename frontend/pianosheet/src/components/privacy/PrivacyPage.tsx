...
const PrivacyPageFC = () => {
    ...
    const domainLink = (
        <a href="https://achord.ru" target="_blank" rel="noreferrer">
            https://achord.ru
        </a>
    );
    ...
    return (
        <Page hideSheetsNav>
            <div className={styles.root}>
                ...
                Мамедовым Азадом Чингиз оглы (далее – Оператор).
                <p>
                ...
                <p>
                    ...
                    получить о посетителях веб-сайта {domainLink}.
                </p>
                <div className={styles.head1}>2. Основные понятия, используемые в Политике</div>
                <p>
                ...
                <p>
                    ...
                    определенному или определяемому Пользователю веб-сайта {domainLink}.
                </p>
                <p>
                ...
                <p>2.10. Пользователь – любой посетитель веб-сайта {domainLink}.</p>
                <p>
                ...
                <div className={styles.head1}>3. Основные права и обязанности Оператора</div>
                <p>
                ...
                <div className={styles.head1}>6. Принципы обработки персональных данных</div>
                <p>
                ...
                <div className={styles.head1}>7. Цели обработки персональных данных</div>
                <p>
                    7.1. Цель обработки персональных данных Пользователя: – информирование
                    Пользователя посредством отправки электронных писем; – предоставление доступа
                ...
                <p>
                    ...
                    Оператору письмо на адрес электронной почты achord.ru@gmail.com с пометкой
                ...
                <ul>
                    <li>
                        перечислите нормативно-правовые акты, регулирующие отношения, связанные с
                        вашей деятельностью, например, если ваша деятельность связана с
                ...
                <p>
                    ...
                    расположенные на сайте {domainLink} или направленные Оператору посредством
                ...
                <div className={styles.head1}>9. Условия обработки персональных данных</div>
                <p>
                ...
                <p>
                    ...
                    адрес электронной почты Оператора achord.ru@gmail.com с пометкой «Актуализация
                    персональных данных».
                </p>
                <p>
                    ...
                    achord.ru@gmail.com с пометкой «Отзыв согласия на обработку персональных
                    данных».
                </p>
                <p>
                ...
                <div className={styles.head1}>12. Трансграничная передача персональных данных</div>
                <p>
                    12.1. Оператор до начала осуществления трансграничной ередачи персональных
                ...
                <div className={styles.head1}>13. Конфиденциальность персональных данных</div>
                ...
                <div className={styles.head1}>14. Заключительные положения</div>
                <p>
                    ...
                    электронной почты achord.ru@gmail.com.
                </p>
                <p>
                ...
                <p>
                    ...
                    по адресу{' '}
                    <a href="https://achord.ru/privacy" target="_blank" rel="noreferrer">
                        https://achord.ru/privacy
                    </a>
                    .
                </p>
            </div>
